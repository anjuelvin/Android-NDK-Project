...
import com.example.anju.toysstore.jsonEntityObjects.PaymentResponseObject;
import com.example.anju.toysstore.jsonEntityObjects.ServerObject;
import com.example.anju.toysstore.network.GsonRequest;
import com.example.anju.toysstore.network.VolleySingleton;
...
public class PayPalCheckoutActivity extends AppCompatActivity {
    ...
    private void initializePayPalPayment(){
        PayPalPayment payment = new PayPalPayment(new BigDecimal(String.valueOf(totalCostPrice)), "CAD", "Toys", PayPalPayment.PAYMENT_INTENT_SALE);
